...
public class SwitchCase {
    public static void main(String[] args) {
        ...
        switch (fruit) {
            case "apple" -> System.out.println("Apples One of the most popular fruits," +
            ...
            case "banana" -> System.out.println("The benefits of bananas go beyond their potassium content." +
            ...
            case "watermelon" -> System.out.println("Watermelon is a highly nutritious summer favorite. " +
            ...
            case "grapes" ->
                    System.out.println("Grapes are convenient, healthy, and particularly high in potassium and vitamin K, which both support heart health.\n" +
                            ...
                            "quercetin\n" +
                            "kaempferol");
            case "pomegranates" -> System.out.println("Pomegranates are known for their high antioxidant content.\n" +
                    "\n" +
